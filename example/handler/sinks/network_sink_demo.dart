...
void main() async {
  ...
  try {
    ...
    print(
        '\x1B[2m[System] Reserving ports: Socket=$socketPort, HTTP=$httpPort\x1B[0m');
    ...
    jLog.info('Raw telemetry event #1');
    jLog.info('Raw telemetry event #2 (Triggers HTTP POST)');
    await _delay();
    ...
    cLog.info('Context window optimized');
    cLog.info('Vector database sync complete');
    cLog.info('Ready for prompt processing');

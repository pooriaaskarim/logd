...
<div align="center">
<div style="background-color: #2B2C50; width: 90%; padding: 20px 0px; display: flex; justify-content: center; border-radius: 10px; box-shadow: 0px 0px 10px #2B2C50; margin-bottom: 20px;">
...
<p style="width: 100%; margin-bottom: 30px;" align="left">Welcome to the <b>logd</b> monorepo. This workspace contains the core <b>logd</b> library, performance benchmarks, and shared development scripts.</p>
</div>


[![Melos](https://img.shields.io/badge/maintained%20with-melos-f700ff.svg?style=flat-square)](https://github.com/invertase/melos)
[![License: BSD 3-Clause](https://img.shields.io/badge/License-BSD%203--Clause-blue.svg)](https://opensource.org/licenses/BSD-3-Clause)
[![Pub Version](https://img.shields.io/pub/v/logd?logo=dart)](https://pub.dev/packages/logd)

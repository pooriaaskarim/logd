  ...
  group('FileSink', () {
    ...
    test('output writes to file', () async {
      ...
      await sink.output(
        const LogDocument(
          nodes: [
            MessageNode(segments: [StyledText('Hello')]),
          ],
        ),
        LogLevel.info,
      );
      await sink.output(
        const LogDocument(
          nodes: [
            MessageNode(segments: [StyledText('World')]),
          ],
        ),
        LogLevel.info,
      );
    ...
    test('TimeRotation rotates based on interval', () async {
      ...
      await sink.output(
        const LogDocument(
          nodes: [
            MessageNode(segments: [StyledText('Log 1')]),
          ],
        ),
        LogLevel.info,
      );
      ...
      await sink.output(
        const LogDocument(
          nodes: [
            MessageNode(segments: [StyledText('Log 2')]),
          ],
        ),
        LogLevel.info,
      );
    ...
    test('SizeRotation rotates based on size', () async {
      ...
      await sink.output(
        const LogDocument(
          nodes: [
            MessageNode(segments: [StyledText('123456')]),
          ],
        ),
        LogLevel.info,
      );
      ...
      await sink.output(
        const LogDocument(
          nodes: [
            MessageNode(segments: [StyledText('7890')]),
          ],
        ),
        LogLevel.info,
      );
    ...
    test('SizeRotation cleans up old backups', () async {
      ...
      await sink.output(
        const LogDocument(
          nodes: [
            MessageNode(segments: [StyledText('trigger')]),
          ],
        ),
        LogLevel.info,
      );
    ...
    test('SizeRotation supports compression', () async {
      ...
      await sink.output(
        const LogDocument(
          nodes: [
            MessageNode(segments: [StyledText('data')]),
          ],
        ),
        LogLevel.info,
      );
      await sink.output(
        const LogDocument(
          nodes: [
            MessageNode(segments: [StyledText('rotate')]),
          ],
        ),
        LogLevel.info,
      );
    ...
    test('TimeRotation cleans up old backups', () async {
      ...
      await sink.output(
        const LogDocument(
          nodes: [
            MessageNode(segments: [StyledText('Initial')]),
          ],
        ),
        LogLevel.info,
      );
